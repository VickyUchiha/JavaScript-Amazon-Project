...
import { addToCart, updateCartQuantity, deleteCartItem } from './cart.js';
...
if(cart && cart.length > 0) {
  cart.forEach(item => {
    ...
    htmlContent += `<div class="cart-item-container js-cart-item-container-${item.productId}" data-product-id="${item.productId}">
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity">
                  ...
                  <span class="delete-quantity-link link-primary js-delete-quantity-${item.productId}" data-product-id="${item.productId}">
                    Delete
                  </span>
                </div>
              </div>
